  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF] pb-36">
        <div className="w-125 h-125 bg-amber-200/20 blur-[65px] absolute" />
        <div className="container mx-auto px-4 pt-6 pb-50 relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center ">
            ...
            <div className="w-full md:w-1/2">
              ...
              <button
                className="bg-black text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-yellow-100  border border-yellow-50 hover:border-yellow-300 transition-colors cursor-pointer hover:text-yellow-600"
                onClick={handleCTA}
              >
                Get Started
              </button>
